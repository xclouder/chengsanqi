...
public partial class GameContext {
    ...
    public GameEntity SetTurnState(Turn newTurn) {
        if (hasTurnState) {
        ...
        entity.AddTurnState(newTurn);
        return entity;
    }

    public void ReplaceTurnState(Turn newTurn) {
        var entity = turnStateEntity;
        if (entity == null) {
            entity = SetTurnState(newTurn);
        } else {
            entity.ReplaceTurnState(newTurn);
        }
    }
...
public partial class GameEntity {
    ...
    public void AddTurnState(Turn newTurn) {
